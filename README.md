...
<sub>Built by <b>Manojkumar</b>. Training data belongs to the athlete; nothing leaves the database except the Strava sync and Gemini prompts you explicitly trigger.</sub>
